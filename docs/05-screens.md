...
> **개정 요약 (2026-08-20 기준)**: 홈은 #53·#55에서 서랍 버튼 화면으로 바뀌었고(타임라인 제거), #57로 **책/언어/CV 3서랍**(데스크톱 3×1·모바일 1×3)이 됐다. 세션 내비는 #59(탭바 [홈] 슬롯 폐지·우상단 홈 버튼) 참조. 아래 5.1~5.2의 카드+타임라인 그림은 사료. 5.3 activity_feed 발행 규약은 유효(타임라인 화면은 없어도 이벤트는 발행).
