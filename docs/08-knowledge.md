...
## 8. CS 모듈 설계 — **폐기 (2026-08-20, 결정 #57)**

> CS 세션 제거로 본 모듈 설계 전체가 폐기됐다. concept·concept_link 테이블과 부속 Storage 버킷 정책은 **제거됐다**(마이그레이션 `20260820090000_drop_knowledge.sql`, §9 DDL 개정, 2026-08-20). 이하 내용은 사료.
